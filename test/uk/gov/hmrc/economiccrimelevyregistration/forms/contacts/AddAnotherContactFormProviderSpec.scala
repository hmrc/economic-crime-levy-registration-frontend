...
class AddAnotherContactFormProviderSpec extends BooleanFieldBehaviours {
  val form = new AddAnotherContactFormProvider()()

  "value" should {
    val fieldName   = "value"
    val requiredKey = "addAnotherContact.error.required"
