...
class DeregisterContactRoleFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "deregisterContactRole.error.required"
  val lengthKey   = "deregisterContactRole.error.length"

  val form = new DeregisterContactRoleFormProvider()()
