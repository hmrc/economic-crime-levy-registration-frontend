...
class DeregisterContactNameFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "deregisterContactName.error.required"
  val lengthKey   = "deregisterContactName.error.length"

  val form = new DeregisterContactNameFormProvider()()
