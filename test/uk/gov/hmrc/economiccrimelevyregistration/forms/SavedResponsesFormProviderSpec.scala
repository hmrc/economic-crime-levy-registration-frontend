...
class SavedResponsesFormProviderSpec extends BooleanFieldBehaviours {
  val form = new SavedResponsesFormProvider()()

  "value" should {
    val fieldName   = "value"
    val requiredKey = "savedResponses.error.required"
