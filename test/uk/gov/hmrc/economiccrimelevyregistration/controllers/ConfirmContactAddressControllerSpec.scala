...
import uk.gov.hmrc.economiccrimelevyregistration.IncorporatedEntityJourneyDataWithValidAddress
  ...
  "onPageLoad" should {
    "return OK and the correct view when no answer has already been provided" in forAll {
      (
        ...
        incorporatedEntityJourneyDataWithValidAddress: IncorporatedEntityJourneyDataWithValidAddress
      ) =>
        val updatedRegistration = registration.copy(
          useRegisteredOfficeAddressAsContactAddress = None,
          incorporatedEntityJourneyData =
            Some(incorporatedEntityJourneyDataWithValidAddress.incorporatedEntityJourneyData),
