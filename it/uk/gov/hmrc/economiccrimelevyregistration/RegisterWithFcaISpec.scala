...
class RegisterWithFcaISpec extends ISpecBase with AuthorisedBehaviour {
  ...
  s"GET ${routes.RegisterWithFcaController.onPageLoad().url}" should {
    behave like authorisedActionWithEnrolmentCheckRoute(routes.RegisterWithFcaController.onPageLoad())
