...
class DeregisterContactNumberISpec extends ISpecBase with AuthorisedBehaviour {
  ...
  s"GET ${uk.gov.hmrc.economiccrimelevyregistration.controllers.deregister.routes.DeregisterContactNumberController.onPageLoad(NormalMode).url}"  should {
    behave like authorisedActionWithoutEnrolmentCheckRoute(
      uk.gov.hmrc.economiccrimelevyregistration.controllers.deregister.routes.DeregisterContactNumberController
  ...
  s"POST ${uk.gov.hmrc.economiccrimelevyregistration.controllers.deregister.routes.DeregisterContactNumberController.onPageLoad(NormalMode).url}" should {
    behave like authorisedActionWithoutEnrolmentCheckRoute(
      uk.gov.hmrc.economiccrimelevyregistration.controllers.deregister.routes.DeregisterContactNumberController
        .onSubmit(NormalMode)
    )
