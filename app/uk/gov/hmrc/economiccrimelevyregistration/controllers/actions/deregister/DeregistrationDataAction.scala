...
class DeregistrationDataActionImpl @Inject() (
...
@ImplementedBy(classOf[DeregistrationDataActionImpl])
trait DeregistrationDataAction extends ActionRefiner[AuthorisedRequest, DeregistrationDataRequest]
