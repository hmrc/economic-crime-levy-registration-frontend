...
@Singleton
class DeregisterContactNumberController @Inject() (
  val controllerComponents: MessagesControllerComponents,
  authorise: AuthorisedActionWithEnrolmentCheck,
  getDeregistrationData: DeregistrationDataAction,
  deregistrationService: DeregistrationService,
  formProvider: DeregisterContactNumberFormProvider,
  view: DeregisterContactNumberView
      ...
      .fold(
        ...
        number => {
          ...
          (for {
            ...
            err => routeError(err),
            _ => toNextPage(mode, routes.DeregisterCheckYourAnswersController.onPageLoad())
          )
        }
      )
  }
