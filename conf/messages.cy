...
ukRevenue.hidden.title = Yr hyn a olygwn wrth ‘trosiant’
...
firstContactRole.title = Beth yw eu rôl yn eich sefydliad?
...
secondContactRole.title = Beth yw eu rôl yn eich sefydliad?
...
checkYourAnswers.firstContact = Cyswllt cyntaf
checkYourAnswers.secondContact = Ail gyswllt
checkYourAnswers.addressDetails = Manylion cyfeiriad
...
checkYourAnswers.ctUtr.label = UTR ar gyfer Treth Gorfforaeth
checkYourAnswers.saUtr.label = UTR ar gyfer Treth Gorfforaeth
checkYourAnswers.nino.label = Rhif Yswiriant Gwladol
checkYourAnswers.dob.label = Dyddiad geni
checkYourAnswers.contactName.label = Enw cyswllt
checkYourAnswers.firstContactName.label = Enw cyswllt cyntaf
checkYourAnswers.contactRole.label = Rôl
checkYourAnswers.firstContactRole.label = Rôl cyswllt cyntaf
checkYourAnswers.contactEmail.label = Cyfeiriad e-bost
checkYourAnswers.firstContactEmail.label = Cyfeiriad e-bost cyswllt cyntaf
checkYourAnswers.contactNumber.label = Rhif ffôn cyswllt
checkYourAnswers.firstContactNumber.label = Rhif ffôn cyswllt cyntaf
checkYourAnswers.secondContact.label = Ychwanegu cyswllt arall
checkYourAnswers.secondContactName.label = Ail enw cyswllt
checkYourAnswers.secondContactRole.label = Ail rôl cyswllt
checkYourAnswers.secondContactEmail.label = Cyfeiriad e-bost ail gyswllt
checkYourAnswers.secondContactNumber.label = Ail rif ffôn cyswllt
...
submitted.p3 = Y dyddiad cau nesaf ar gyfer cyflwyno datganiad a gwneud taliad yw {0}. Codir llog arnoch os ydych yn talu’n hwyr.
submitted.p4 = Ni fyddwch yn cael e-bost na hysbysiad oddi wrth CThEF i’ch atgoffa i gyflwyno datganiad.
submitted.previousFY = Mae angen i chi gyflwyno Ffurflen Dreth ar gyfer unrhyw flynyddoedd ariannol blaenorol cyn gynted â phosibl. Byddant yn dangos fel hwyr.
...
registration.received.p7.previous = Mae angen i chi gyflwyno Ffurflen Dreth ar gyfer unrhyw flynyddoedd ariannol blaenorol cyn gynted â phosibl. Byddant yn dangos fel hwyr.
registration.received.p7.current = Y dyddiad cau nesaf ar gyfer cyflwyno datganiad a gwneud taliad yw {0}. Codir llog arnoch os ydych yn talu’n hwyr.
registration.received.p7.both.years.p1 = Y dyddiad cau nesaf ar gyfer cyflwyno datganiad a gwneud taliad yw {0}. Codir llog arnoch os ydych yn talu’n hwyr.
registration.received.p7.both.years.p2 = Mae angen i chi gyflwyno Ffurflen Dreth ar gyfer unrhyw flynyddoedd ariannol blaenorol cyn gynted â phosibl. Byddant yn dangos fel hwyr.
...
start.amend.body.p1 = Defnyddiwch y gwasanaeth hwn i ddiwygio eich manylion cofrestru Ardoll Troseddau Economaidd (ECL).
start.amend.body.p2 = Ni fyddwch yn gallu defnyddio’r atebion gwnaethoch eu hanfon ar gyfer eich cofrestriad gwreiddiol. Bydd angen i chi cyflwyno’ch atebion i gyd eto, yn cynnwys yr hyn yr ydych am ei ddiwygio.
start.amend.body.p3 = Ni allwch newid eich goruchwyliwr gwrth-wyngalchu arian i’r Comisiwn Hapchwarae (GC) neu’r Awdurdod Ymddygiad Ariannol (FCA).
start.amend.body.p4 = Bydd yn rhaid i chi roi gwybod i ni am y canlynol:
start.amend.body.p5 = Ar ôl i chi ddiwygio’ch cofrestriad, byddwn yn adolygu’ch atebion. Bydd y broses hon yn cymryd hyd at 15 diwrnod gwaith.
start.amend.h1 = Diwygio’ch cofrestriad Ardoll Troseddau Economaidd
start.amend.h2 = Cyn i chi ddechrau
start.amend.list.b1 = unrhyw gyfnodau cyfrifyddu ar gyfer eich sefydliad sy’n dod i ben yn y flwyddyn ariannol berthnasol
start.amend.list.b2 = incwm eich sefydliad yn y DU mewn unrhyw gyfnodau cyfrifyddu perthnasol
start.amend.list.b3 = os gwnaeth eich sefydliad cynnal gweithgareddau a reoleiddir gan reoliadau gwyngalchu arian ar gyfer y flwyddyn ariannol lawn
start.amend.list.b4 = manylion y gallwn eu defnyddio i adnabod eich busnes - gweler y rhestr o fanylion sydd eu hangen, {0}
start.amend.list.b4.link = <a href="https://www.gov.uk/guidance/register-for-the-economic-crime-levy" class="govuk-link">gweler y rhestr o fanylion sydd eu hangen</a>
start.amend.list.b5 = y sector busnes y mae eich sefydliad yn gweithredu ynddo
start.amend.list.b6 = manylion rhywun yn eich sefydliad sy’n gallu gweithredu fel pwynt cyswllt ar gyfer unrhyw weithgareddau sy’n gysylltiedig â’r ECL
...
deregisterContactRole.title = Beth yw eu rôl yn eich sefydliad?
