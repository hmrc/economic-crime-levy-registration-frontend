service.name = Register for Economic Crime Levy
...
index.title = economic-crime-levy-registration-frontend
index.heading = economic-crime-levy-registration-frontend
